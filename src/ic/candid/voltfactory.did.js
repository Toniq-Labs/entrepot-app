export default ({ IDL }) => {
  ...
  return IDL.Service({
    ...
    'admin_addVersion' : IDL.Func([IDL.Nat, IDL.Vec(IDL.Nat8)], [], []),
    ...
    'getAuthorization' : IDL.Func(
        [IDL.Nat],
        [IDL.Opt(Authorization)],
        ['query'],
      ),
    ...
    'getLatestWasm' : IDL.Func([], [IDL.Nat, IDL.Vec(IDL.Nat8)], ['query']),
    'getOwnerCanister' : IDL.Func(
        [IDL.Principal],
        [IDL.Opt(canister_id)],
        ['query'],
      ),
    ...
    'paymentDetails' : IDL.Func([], [AccountIdentifier, IDL.Nat64], ['query']),
