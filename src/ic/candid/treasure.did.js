export default ({ IDL }) => {
  ...
  const TPRequest = IDL.Record({
    ...
    'subaccount' : SubAccount__1,
    'locked' : IDL.Opt(Time),
    'repayment' : IDL.Opt(AccountIdentifier__1),
    'filled' : IDL.Opt(Time),
    'lender' : IDL.Opt(AccountIdentifier__1),
    'length' : Time,
    'amount' : IDL.Nat64,
    'payment' : IDL.Opt(AccountIdentifier__1),
    'defaulted' : IDL.Bool,
  });
  ...
  const Treasure = IDL.Service({
    ...
    'tokenTransferNotification' : IDL.Func(
        [TokenIdentifier__1, User__1, Balance__1, Memo__1],
        [IDL.Opt(Balance__1)],
        [],
      ),
    'tokens' : IDL.Func([AccountIdentifier__1], [Result_4], ['query']),
    'tokens_ext' : IDL.Func([AccountIdentifier__1], [Result_3], ['query']),
    ...
    'tp_fees' : IDL.Func([], [IDL.Nat64, IDL.Nat64], []),
    'tp_fill' : IDL.Func(
        [TokenIdentifier__1, AccountIdentifier__1, IDL.Nat64],
        [Result_1],
        [],
      ),
    'tp_loans' : IDL.Func([], [IDL.Vec(IDL.Tuple(TokenIndex, TPRequest))], []),
    'tp_loansActive' : IDL.Func(
        [],
    ...
    'tp_settle' : IDL.Func([AccountIdentifier__1], [Result], []),
    'tp_tokenOwner' : IDL.Func(
        [TokenIdentifier__1],
        [IDL.Opt(AccountIdentifier__1)],
        [],
      ),
    'tp_whitelisted' : IDL.Func([], [IDL.Vec(IDL.Text)], []),
