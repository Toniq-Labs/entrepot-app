    ...
    const advanced_token = IDL.Service({
        DEXDebugData: IDL.Func(
            ...
            [
                ...
                IDL.Vec(IDL.Tuple(CurrencyPair, IDL.Tuple(IDL.Vec(OrderId), IDL.Vec(OrderId)))),
        ...
        allRegistry: IDL.Func(
            [],
            [IDL.Vec(IDL.Tuple(TokenIndex, IDL.Vec(IDL.Tuple(AccountIdentifier_3, Balance_2))))],
            ['query'],
        ),
        ...
        numberOfTokenHolders: IDL.Func([TokenIdentifier_2], [Result_6], ['query']),
