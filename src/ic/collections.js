...
var collections = [
  {
    ...
    keywords : "2D PFP NFT",
    banner : "/collections/prime8s/banner.png",
    ...
    web : "https://medium.com/@ICPrime8s",
    route: "prime8s",
    unit : "Prime8s",
    nftv : false,
    mature: false,
    ...
    blurb: (<><p>For nearly 60 million years Prime8s have roamed the earth and now they're coming to the Internet Computer! ICPrime8s is a collection of 20,000 (total) NFTs and will be released as 5 seperate collections of 4000 NFTs each. Following the evolutionary timeline of Prime8s, each release will depict a different Prime8 unique with its own traits and characteristics. Give us a follow on Twitter to keep up to date with more information including detailed descriptions of the art and characteristics, our initial roadmap, and contests and giveaways!</p></>),
  },
  {
