...
export default class RosettaApi {
     ...
     * @returns {Promise<BigNumber | RosettaError>} The ICP account balance of the specified account,
     *   or a RosettaError for error.
     */
     ...
     * @param maxBlockIndex {number} The block index to start at. If not specified, start at current block.
     * @param offset {number} The offset from maxBlockIndex to start returning transactions.
     * @returns {Promise<Transaction[] | null>} An array of Transaction objects, or a RosettaError for error.
     */
    ...
    /**
     * Return the /block response for the block corresponding to the specified block index (i.e., block height).
     *
     * @private
