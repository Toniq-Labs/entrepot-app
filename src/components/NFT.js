...
export default function NFT(props) {
  ...
  const [earnCollections, setEarnCollections] = React.useState(
    props.collections.filter(a => a.earn == true).map(a => a.id),
  );
    ...
    if (props.view == 'new-request') {
      ...
      if (listing) {
        ...
        buttons.push([
          ...
          () => props.transferNft({id: tokenid, listing: listing}, props.loader, transferRefresh),
        ]);
      } else {
        if (wrappedCanisters.concat(unwrappedCanisters).indexOf(canister) < 0) {
          ...
          if (unwrappedCanisters.indexOf(canister) >= 0) {
            ...
            buttons.push([
              currentBtn == 0 && currentBtnText ? buttonLoadingText : 'Sell',
              () =>
                props.wrapAndlistNft({id: tokenid, listing: listing}, props.loader, props.refresh),
            ]);
            buttons.push([
              currentBtn == 1 && currentBtnText ? buttonLoadingText : 'Transfer',
              () =>
            ...
            buttons.push([
              'Unwrap',
              () => props.unwrapNft({id: tokenid, listing: listing}, props.loader, transferRefresh),
            ]);
          }
        }
        //Custom
  ...
  const nriLink = () => {
    if (canister === 'bxdf4-baaaa-aaaah-qaruq-cai')
      return 'https://nntkg-vqaaa-aaaad-qamfa-cai.ic.fleek.co/?collection=punks&tokenid=' + index;
    if (canister === '3db6u-aiaaa-aaaah-qbjbq-cai')
      return 'https://nntkg-vqaaa-aaaad-qamfa-cai.ic.fleek.co/?collection=drips&tokenid=' + index;
    if (canister === 'q6hjz-kyaaa-aaaah-qcama-cai')
      return 'https://nntkg-vqaaa-aaaad-qamfa-cai.ic.fleek.co/?collection=bunnies&tokenid=' + index;
      ...
      >
        ...
        >
          <div style={{...styles.avatarSkeletonContainer}}>
            {EntrepotDisplayNFT(getEXTCanister(canister), tokenid, imgLoaded, nftImg(), () =>
              setImgLoaded(true),
            )}
          </div>
          {offerCount > 0 ? (
        ...
        {typeof props.view !== 'undefined' &&
        ['collected', 'selling', 'offers-received', 'new-request', 'earn-nfts'].indexOf(
          props.view,
        ) >= 0 ? (
              ...
              <>
                {_isLocked() ? (
                  <span style={{display: 'block'}}>
                    Unlocks{' '}
                    <Timestamp relative autoUpdate date={Number(listing.locked[0] / 1000000000n)} />
                  </span>
                ) : (
                  <Button
                    onClick={ev => {
