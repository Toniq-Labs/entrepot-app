        ...
        <Alert severity="warning"><strong>
          ...
          <Grid container style={{padding:20}}>
            ...
            <Grid item xs={6} style={{textAlign:"right"}}>
              <span><PriceICP size={20} price={props.price} /></span>
            </Grid>
            <Grid item xs={6} style={{textAlign:"left"}}>
              <strong>Earn Potential*</strong>
            </Grid>
            <Grid item xs={6} style={{textAlign:"right"}}>
              <span><PriceICP size={20} price={EntrepotEarnDetailsData(props.tokenid)} /></span>
            </Grid>
            <Grid item xs={6} style={{textAlign:"left"}}>
              <strong>Profit/Loss*</strong>
            </Grid>
            <Grid item xs={6} style={{textAlign:"right"}}>
              <span style={(EntrepotEarnDetailsData(props.tokenid) > props.price ? {color:"green"} : {color:"red"})}><PriceICP size={20} price={EntrepotEarnDetailsData(props.tokenid)-props.price} /></span>
            </Grid>
          </Grid>
