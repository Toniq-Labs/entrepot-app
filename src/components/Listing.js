...
export default function Listing(props) {
    ...
    const genes =
        props.collection !== 'e3izy-jiaaa-aaaah-qacbq-cai'
            ? ''
            : getGenes(props.listing[2].nonfungible.metadata[0]);

    const navigate = useNavigate();
    const tokenid = extjs.encodeTokenId(props.collection, props.listing[0]);

    const backgrounds_details = [
        'Hexagon',
        'Snowflake',
        'Diamond',
        'Multi-point star',
    ...
    const patterns_details = [
        'Arrows',
        'Diamond Up / Arrow Diag',
        'Arrow Circles',
        'Circle Up / Arrow Diag',
        'Diamonds',
        'Star Circles',
        'Circle Up / Line Diag',
        'Arrow Up / Circle Diag',
        'Arrow Circle Up / Line Diag',
        'Flower Petals',
    ];
    const faces_details = [
        'Circle',
        'Horizontal Hexagon #1',
        'Pentagon',
        'Snowflake',
        'Horizontal Hexagon #2',
        'Bumpy',
        'Vertical Hexagon',
        'Heart',
        'Octagon',
    ...
    const colors = {
        '#11f807': 'Green',
        '#12c58e': 'Mountain Meadow',
        '#1322a2': 'Torea Bay',
        '#14468f': 'Tory Blue',
        '#18b50d': 'La Palma',
        '#1bb81e': 'American Green',
        '#276e6c': 'Paradiso',
        '#2ce19a': 'Shamrock',
        '#2e6b6d': 'Casal',
        '#3092f2': 'Dodger Blue',
        ...
        '#390a2e': 'Loulou',
        '#3a70b9': 'Indigo',
        '#3f6cba': 'San Marino Light',
        '#41589e': 'San Marino Dark',
        '#46f2b5': 'Bright Turquoise Blue',
        '#48a7c6': 'Pelorous',
        '#49f5b7': 'Aquamarine',
        '#4b147b': 'Persian Indigo',
        '#4b5c04': 'Verdun Green',
        '#4f4632': 'Judge Gray',
        '#51720b': 'Green Leaf',
        '#51ceb7': 'Puerto Rico',
        ...
        '#63268a': 'Daisy Bush',
        '#6acc47': 'Mantis',
        '#6aecb4': 'Dull Turquoise Blue',
        '#712553': 'Tawny Port',
        '#772cd5': 'Purple Heart',
        '#77e184': 'Dark Pastel Green',
        '#78fa45': 'Screamin Green',
        '#7fa8e9': 'Light Portage',
        '#8395ef': 'Dark Portage',
        '#858361': 'Clay Creek',
        '#85e48f': 'Light Pastel Green',
        '#94ad0b': 'Pistachio',
        '#9716b8': 'Seance',
        '#9784f9': 'Light Purple',
        '#9bfb6f': 'Mint Green',
        '#9ef6c9': 'Bright Magic Mint',
        '#a05b1b': 'Hawaiian Tan',
        '#a46d75': 'Coral Tree',
        '#a8edd7': 'Dull Magic Mint',
        '#ad8893': 'Bouquet',
        '#adca25': 'Key Lime Pie',
        '#b3c7b1': 'Clay Ash',
        '#b647d0': 'Amethyst',
    ...
    const handlePopupOpen = () => {
        ...
        var saleTransactions = props.transactions.filter(
            (_t) =>
                extjs.encodeTokenId('e3izy-jiaaa-aaaah-qacbq-cai', props.listing[0]) === _t.token,
        );
                ...
                data.push(
                    JSON.parse(
                        '{"date":"' +
                            _showDate(t.time) +
                            '","price":' +
                            _showListingPrice(t.price) +
                            ',"averagePrice":' +
                            volume / (saleTransactions.indexOf(t) + 1) +
                            '}',
                    ),
                );
            });
            ...
            return (
                <Grid item md={6} sm={6} xs={6}>
                    <Typography
                        ...
                        gutterBottom
                    >
                        {props.listing[2].nonfungible.metadata[0][0] === 0
                            ? 'Pack'
                            : '#' +
                              props.listing[2].nonfungible.metadata[0][0] +
                              ' - ' +
                              t[props.listing[2].nonfungible.metadata[0][1]]}
                    </Typography>
                </Grid>
            );
        }
    ...
    return (
        <Grid
            style={{height: '100%'}}
            item
            xl={props.gridSize === 'small' ? 3 : 2}
            lg={props.gridSize === 'small' ? 3 : 2}
            md={4}
            sm={6}
            xs={6}
        >
                                                        ...
                                                        <AccordionDetails>
                                                            ...
                                                            >
                                                                <Grid item xs={4}>
                                                                    ...
                                                                    <br />
                                                                    {genes.battle.attack.dominant} (
                                                                    {genes.battle.attack.recessive})
                                                                </Grid>
                                                                <Grid item xs={4}>
                                                                    <strong>Magic</strong>
                                                                    <br />
                                                                    {genes.battle.magic.dominant} (
                                                                    {genes.battle.magic.recessive})
                                                                </Grid>
                                                                <Grid item xs={4}>
                                                                    <strong>Range</strong>
                                                                    <br />
                                                                    {genes.battle.range.dominant} (
                                                                    {genes.battle.range.recessive})
                                                                </Grid>
                                                                <Grid item xs={4}>
                                                                    <strong>Health</strong>
                                                                    <br />
                                                                    {genes.battle.health.dominant} (
                                                                    {genes.battle.health.recessive})
                                                                </Grid>
                                                                <Grid item xs={4}>
                                                                    <strong>Defense</strong>
                                                                    <br />
                                                                    {
                                                                        genes.battle.defense
                                                                            .dominant
                                                                    }{' '}
                                                                    (
                                                                    {genes.battle.defense.recessive}
                                                                    )
                                                                </Grid>
                                                                <Grid item xs={4}>
                                                                ...
                                                                <Grid item xs={4}>
                                                                    <strong>Base</strong>
                                                                    <br />
                                                                    {genes.battle.base.dominant} (
                                                                    {genes.battle.base.recessive})
                                                                </Grid>
                                                                <Grid item xs={4}>
                                                                    <strong>Speed</strong>
                                                                    <br />
                                                                    {genes.battle.speed.dominant} (
                                                                    {genes.battle.speed.recessive})
                                                                </Grid>
                                                            </Grid>
                                                        </AccordionDetails>
                                                    </Accordion>
