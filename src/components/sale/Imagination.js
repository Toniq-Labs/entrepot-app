...
export default function Imagination(props) {
    ...
    const buyFromSale = async (type) => {
        ...
        var v = await props.confirm(
            'Please confirm',
            'Are you sure you want to continue with this purchase of 1 NFT for the total price of ' +
        ...
        try {
            ...
            var r = await api
                .canister('px5ub-qqaaa-aaaah-qcjxa-cai')
                .reserve(price, type, props.account.address, _getRandomBytes());
            ...
            <div style={styles.main}>
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/imagination/banner.jpg')",
                        }}
                    ></div>
                    <h1>Welcome to the official Imagination Project sale</h1>
                    <p>
                        A photographer who brings a sense of underlying magic to the meticulous
                        conceptual images he creates.
                    </p>
                    <p>
                        Bringing his attentive eye and deep relationship with nature into the built
                        studio environment, Ted's still life images are anything but static, as
                        every photograph is infused with a sense of action or motion.
                    </p>
                    <p>
                        A true polymath who works across a number of sectors, Ted is adept at
                        bringing together teams of scientists, model-builders, engineers, doctors,
                        mathematicians, sculptors, set designers and artists to create engaging
                        imagery for his international clientele and personal projects.
                    </p>
                    <p>
                        Ted's recent work with The Royal Academy of Engineering has exhibited at The
                        National Science and Media Museum (UK) and Edinburgh Science Festival (UK)
                    </p>
                    <p>
                        The Imagination Project, created 50 photographs over the course of a year,
                        celebrating the human imagination in all its wild and vast diversity. The
                        Projects narrative is formed through the interpretation of 400 years of
                        Patents. A veritable encyclopaedia of human achievement.
                    </p>
                </div>
                <br />
                <br />
                ...
                <Grid container spacing={2} style={{}}>
                    ...
                    <Grid className={classes.stat} item md={4} xs={6}>
                        ...
                        <br />
                        <span style={{fontWeight: 'bold', color: '#00b894', fontSize: '2em'}}>
                            {remaining ? 160 - remaining : 'Loading...'}
                        </span>
                    </Grid>
                </Grid>
                <br />
                                ...
                                <>
                                    ...
                                    >
                                        {[0, 1, 2, 4, 6, 7, 3, 5].map((a) => {
                                            return (
                                                <Flip2
                                                    remaining={getRemaining(a)}
                                                    saleLive={Date.now() >= startTime}
                                                    button={
                                                        <Button
                                                            variant={'contained'}
                                                            color={'primary'}
                                                    ...
                                                    front={
                                                        'https://px5ub-qqaaa-aaaah-qcjxa-cai.raw.ic0.app/?asset=' +
                                                        a +
                                                        '.jpg'
                                                    }
                                                    back={
                                    ...
                                    <br />
                                    <p>
                                        <strong>Please note:</strong> All transactions are secured
                                        via Entrepot's escrow platform. There are no refunds or
                                        returns, once a transaction is made it can not be reversed.
                                        Entrepot provides a transaction service only. By clicking
                                        one of the buttons above you show acceptance of our{' '}
                                        <a
