...
export default function Frog(props) {
  ...
  const _updates = async () => {
    var stats = await api.canister("erpx2-pyaaa-aaaah-qcqsq-cai", "sale").salesStats((props.account ? props.account.address : ""));
  ...
  const buyFromSale = async (qty, price) => {
    ...
    try {
      ...
      var r = await api
        .canister("erpx2-pyaaa-aaaah-qcqsq-cai", "sale")
        .reserve(
          price,
          qty,
      ...
      while (true) {
        try {
          ...
          r3 = await api.canister("erpx2-pyaaa-aaaah-qcqsq-cai", "sale").retreive(paytoaddress);
  ...
  return (
    <>
      <div style={styles.main}>
        ...
        <div style={{width: "100%", height: 200, borderRadius:10,backgroundPosition: "center", backgroundSize: "cover",backgroundImage:"url('/collections/frog2d/VoxelBanner.png')"}}></div>
        <h1>Welcome to the official Frog Nation 2.0 - Voxel Assassins!!! sale</h1>
        </div>
