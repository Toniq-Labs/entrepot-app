...
export default function Interitus(props) {
  ...
  const _updates = async () => {
    var stats = await api.canister("zejmq-rqaaa-aaaah-qcnsq-cai", "sale").salesStats((props.account ? props.account.address : ""));
    ...
    try {
      ...
      while (true) {
        try {
          ...
          r3 = await api.canister("zejmq-rqaaa-aaaah-qcnsq-cai", "sale").retreive(paytoaddress);
  ...
  return (
    <>
      <div style={styles.main}>
        ...
        <div style={{width: "100%", height: 200, borderRadius:10,backgroundPosition: "top", backgroundSize: "cover",backgroundImage:"url('/collections/interitus/banner.jpg')"}}></div>
