...
export default function Interitus(props) {
    ...
    var whitelistend = 1640275200000;
    var presaleprice = 250000000n;
    var totalToSell = 350;
    var saleOver = false;
    ...
    const _updates = async () => {
        var stats = await api
            .canister('zejmq-rqaaa-aaaah-qcnsq-cai', 'sale')
                ...
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/interitus/banner.jpg')",
                        }}
                    ></div>
                    <h1>Welcome to the official Elementum: Interitus sale</h1>
                </div>
                <Grid
                ...
                >
                    ...
                    {whitelist ? (
                        <Grid className={classes.stat} item md={3} xs={6}>
                            ...
                            <br />
                            <span style={{fontWeight: 'bold', color: '#00b894', fontSize: '2em'}}>
                                {_showListingPrice(presaleprice)} ICP
                            </span>
                        </Grid>
                    ) : (
                        ''
                    ...
                    <>
                        {!saleOver && remaining > 0 ? (
                                        ...
                                        <p>
                                            <strong>
                                                <span style={{fontSize: '20px', color: 'black'}}>
                                                    You are on the whitelist! The private sale
                                                    starts{' '}
                                                    <Timestamp
                                                        relative
                                                        autoUpdate
                                ...
                                Date.now() < whitelistend ? (
                                    <>
                                        <p>
                                            <strong>
                                                <span style={{fontSize: '20px', color: 'black'}}>
                                                    You are on the whitelist! You can mint as many
                                                    NFTs at 2.5ICP each for the first 1 hour
                                                    (limited to the first 125 sold)!
                                                </span>
                                            </strong>
                                        </p>
                                        ...
                                        {totalToSell - remaining < 125 ? (
                                            <>
                                                ...
                                                <p>
                                                    <strong>Please note:</strong> All transactions
                                                    are secured via Entrepot's escrow platform.
                                                    There are no refunds or returns, once a
                                                    transaction is made it can not be reversed.
                                                    Entrepot provides a transaction service only. By
                                                    clicking one of the buttons above you show
                                                    acceptance of our{' '}
                                                    <a
                                            ...
                                            <p>
                                                <strong>
                                                    <span style={{fontSize: '20px', color: 'red'}}>
                                                        Sorry, there are currently no pre-sale NFTs
                                                        available.
                                                    </span>
                                                </strong>
                                            </p>
                            ...
                            <p>
                                <strong>
                                    <span style={{fontSize: '20px', color: 'red'}}>
                                        Sorry, the sale is now over! You can grab your NFT from the
                                        marketplace soon!
                                    </span>
                                </strong>
                            </p>
