                ...
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/cyman/banner.jpg')",
                        }}
                    ></div>
                    ...
                    <Alert
                        ...
                        severity="warning"
                    >
                        CYMEN NFTs will be revealed after 24 hours from start of sale.
                    </Alert>
                    <br />
                </div>
                <Grid
                                        ...
                                        <p>
                                            <strong>
                                                <span style={{fontSize: '20px', color: 'black'}}>
                                                    You are on the whitelist! You can purchase at
                                                    the whitelist price until all whitelisted
                                                    allocations have been sold!
                                                </span>
                                            </strong>
                                        </p>
                                        <br />
                            ...
                            <p>
                                <strong>
                                    <span style={{fontSize: '20px', color: 'red'}}>
                                        Sorry, the sale is now over! You can grab your CYMAN from
