            ...
            <div style={styles.main}>
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/banner/hauntedhamsters.jpg')",
                        }}
                    ></div>
                ...
                <Grid container spacing={2} style={{}}>
                    ...
                    <Grid className={classes.stat} item md={4} xs={6}>
                        ...
                        <br />
                        <span style={{fontWeight: 'bold', color: '#00b894', fontSize: '2em'}}>
                            {remaining ? 6500 - remaining : 'Loading...'}
                        </span>
                    </Grid>
                </Grid>
                <br />
                            ...
                            <p>
                                <strong>
                                    <span style={{fontSize: '20px', color: 'red'}}>
                                        Sorry, the sale is now over! You can grab your Haunted
                                        Hamster from the marketplace soon!
                                    </span>
                                </strong>
                            </p>
                        )}
