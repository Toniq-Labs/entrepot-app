        ...
        <>
            <div style={styles.main}>
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/poked/banner.jpg')",
                        }}
                    ></div>
                ...
                >
                    <Grid
                        style={
                            Date.now() >= round2start || remaining1 === 0 ? {opacity: '0.4'} : {}
                        }
                    ...
                    <Grid
                        style={
                            Date.now() >= round3start || remaining2 === 0 ? {opacity: '0.4'} : {}
                        }
                        className={classes.stat}
                        item
                        md={2}
                    ...
                    <Grid
                        style={
                            Date.now() >= round4start || remaining3 === 0 ? {opacity: '0.4'} : {}
                        }
                        className={classes.stat}
                        item
                        md={2}
                    ...
                    <Grid
                        style={remaining4 === 0 ? {opacity: '0.4'} : {}}
                        className={classes.stat}
                        item
                        md={2}
                        xs={6}
                ...
                {saleOver || remaining4 === 0 ? (
                    <p>
                        <strong>
                            <span style={{fontSize: '20px', color: 'red'}}>
                                Sorry, the sale is now over! You can grab your Poked Bot from the
                                marketplace soon!
                            </span>
                        </strong>
                    </p>
                    ...
                    <>
                        {whitelist && Date.now() < round4start ? (
                            <Alert
                                style={{marginBottom: 40, width: 800, margin: '0 auto'}}
                                severity="success"
                            >
                                <strong>
                                    You are on the whitelist - you can purchase 1 bot during one of
                                    the Presale Rounds!
                                </strong>
                            </Alert>
                        ) : (
                                ...
                                <p>
                                    <strong>
                                        <span style={{fontSize: '20px', color: 'black'}}>
                                            The first presale round starts{' '}
                                            <Timestamp
                                                relative
                                                autoUpdate
                                                date={round1start / 1000}
                                            />{' '}
                                                    ...
                                                    <>
                                                        <p>
                                                            <strong>
                                                                ...
                                                                >
                                                                    The first presale round has sold
                                                                    out. The second presale round
                                                                    starts{' '}
                                                                    <Timestamp
                                                                        relative
                                                                        autoUpdate
                                                                        date={round2start / 1000}
                                                                    />{' '}
                                                                    for whitelisted users only!
                                                                    <br />
                                                                    <br />
                                                        ...
                                                        {whitelist ? (
                                                            <>
                                                                ...
                                                                <p>
                                                                    ...
                                                                    All transactions are secured via
                                                                    Entrepot's escrow platform.
                                                                    There are no refunds or returns,
                                                                    once a transaction is made it
                                                                    can not be reversed. Entrepot
                                                                    provides a transaction service
                                                                    only. By clicking one of the
                                                                    buttons above you show
                                                                    acceptance of our{' '}
                                                                    <a
                                                            ...
                                                            <>
                                                                <p>
                                                                    <strong>
                                                                        ...
                                                                        >
                                                                            The second presale round
                                                                            has sold out. The final
                                                                            presale round starts{' '}
                                                                            <Timestamp
                                                                                relative
                                                                                autoUpdate
                                                                                date={
                                                                ...
                                                                {whitelist ? (
                                                                    <>
                                                                        ...
                                                                        <p>
                                                                            ...
                                                                            secured via Entrepot's
                                                                            escrow platform. There
                                                                            are no refunds or
                                                                            returns, once a
                                                                            transaction is made it
                                                                            can not be reversed.
                                                                            Entrepot provides a
                                                                            transaction service
                                                                            only. By clicking one of
                                                                            the buttons above you
                                                ...
                                                {Date.now() < round4start ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <p>
                                                            ...
                                                            returns, once a transaction is made it
                                                            can not be reversed. Entrepot provides a
                                                            transaction service only. By clicking
                                                            one of the buttons above you show
                                                            acceptance of our{' '}
                                                            <a
                                                                href="https://docs.google.com/document/d/13aj8of_UXdByGoFdMEbbIyltXMn0TXHiUie2jO-qnNk/edit"
                                                                target="_blank"
