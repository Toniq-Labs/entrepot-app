                ...
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/spaceapes/banner.jpg')",
                        }}
                    ></div>
                            ...
                            <p>
                                <strong>
                                    <span style={{fontSize: '20px', color: 'red'}}>
                                        Sorry, the sale is currently over but there may still be
                                        additional NFTs from failed transactions that may be
                                        recycled and put up for sale again very soon!
                                    </span>
                                </strong>
                            </p>
                        )}
