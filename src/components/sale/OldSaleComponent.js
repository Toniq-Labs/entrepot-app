                ...
                {remaining > 0 ? (
                  <>
                    ...
                    {Date.now() >= whitelistTime ? (
                      <>
                            ...
                            return (
                              <Grid className={classes.stat} item sm={3}>
                                <Button
                                  ...
                                  color={'primary'}
                                  onClick={() =>
                                    buyFromSale(Number(o[0]), o.length > 1 ? o[1] : price * o[0])
                                  }
                                  style={{fontWeight: 'bold', margin: '0 auto'}}
                                >
                                  Buy {Number(o[0])} NFT{o[0] === 1 ? '' : 's'}
                                  <br />
                                  for {_showListingPrice(o.length > 1 ? o[1] : price * o[0])} ICP
                                </Button>
                              </Grid>
                            );
                          })}
                        ...
                        <p>
                          <strong>Please note:</strong> All transactions are secured via Entrepot's
                          escrow platform. There are no refunds or returns, once a transaction is
                          made it can not be reversed. Entrepot provides a transaction service only.
                          By clicking one of the buttons above you show acceptance of our{' '}
                          <a
                            href="https://docs.google.com/document/d/13aj8of_UXdByGoFdMEbbIyltXMn0TXHiUie2jO-qnNk/edit"
                            target="_blank"
                          >
                  ...
                  <>
                    <p>
                      <strong>
                        <span style={{fontSize: '20px', color: 'black'}}>
                          There are currently no more NFTs available, but not all sales have settled
                          yet. If these transactions do not settle in time, the NFTs will become
