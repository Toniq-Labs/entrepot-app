...
export default function Sword(props) {
  ...
  const _updates = async () => {
    var stats = await api.canister("4kubm-wiaaa-aaaah-qcnoa-cai", "sale").salesStats((props.account ? props.account.address : ""));
  ...
  const buyFromSale = async (qty, price) => {
    ...
    try {
      ...
      var r = await api
        .canister("4kubm-wiaaa-aaaah-qcnoa-cai", "sale")
        .reserve(
          price,
          qty,
      ...
      while (true) {
        try {
          ...
          r3 = await api.canister("4kubm-wiaaa-aaaah-qcnoa-cai", "sale").retreive(paytoaddress);
  ...
  return (
    <>
      <div style={styles.main}>
        ...
        <div style={{width: "100%", height: 200, borderRadius:10,backgroundPosition: "center", backgroundSize: "cover",backgroundImage:"url('/collections/sword/banner.png')"}}></div>
        <h1>Welcome to the official SwordNFT sale</h1>
        </div>
