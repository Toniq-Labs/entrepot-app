                ...
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/prime8s/banner.jpg')",
                        }}
                    ></div>
                                        ...
                                        <p>
                                            <strong>
                                                <span style={{fontSize: '20px', color: 'black'}}>
                                                    You are on the whitelist! The sale starts{' '}
                                                    <Timestamp
                                                        relative
                                                        autoUpdate
                                                        date={startTime / 1000}
                                ...
                                {whitelist && Date.now() >= startTime ? (
                                    <>
                                        <p>
                                            <strong>
                                                <span style={{fontSize: '20px', color: 'black'}}>
                                                    You are on the whitelist! You can mint up to 3
                                                    NFTs at 0.1ICP each (limited to first 250 sold)!
                                                </span>
                                            </strong>
                                        </p>
                                        ...
                                        <>
                                            ...
                                            <p>
                                                ...
                                                refunds or returns, once a transaction is made it
                                                can not be reversed. Entrepot provides a transaction
                                                service only. By clicking one of the buttons above
                                                you show acceptance of our{' '}
                                                <a
