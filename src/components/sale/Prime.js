...
export default function Prime(props) {
  ...
  const [price, setPrice] = React.useState(30000000n);
  ...
  const _updates = async () => {
    var stats = await api.canister("5h2fc-zaaaa-aaaah-qcnjq-cai", "sale").salesStats((props.account ? props.account.address : ""));
  ...
  const buyFromSale = async (qty, price) => {
    ...
    try {
      ...
      var r = await api
        .canister("5h2fc-zaaaa-aaaah-qcnjq-cai", "sale")
        .reserve(
          price,
          qty,
      ...
      while (true) {
        try {
          ...
          r3 = await api.canister("5h2fc-zaaaa-aaaah-qcnjq-cai", "sale").retreive(paytoaddress);
                ...
                <>
                  ...
                  <>
                    <Grid justifyContent="center" direction="row" alignItems="center" container spacing={2} style={{}}>
                      ...
                      >
                        Buy 1 Prime8<br />for {_showListingPrice(presaleprice)} ICP
                      </Button>
                    </Grid>
                    ...
                    {buyOptions.map(o => {
                      return (<Grid className={classes.stat} item sm={3}>
                        <Button
                          ...
                          style={{ fontWeight: "bold", margin: "0 auto" }}
                        >
                          Buy {o[0]} Prime8{o[0] === 1 ? "" : "s"}<br />for {_showListingPrice(o[1])} ICP
                        </Button>
                      </Grid>);
                    })}
                  </Grid>
