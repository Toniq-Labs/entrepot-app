                ...
                <div style={styles.main}>
                    ...
                    >
                        ...
                        <Grid className={classes.stat} item md={3} xs={6}>
                            ...
                            <br />
                            <span
                                style={{fontWeight: 'bold', color: 'rgb(189 1 1)', fontSize: '2em'}}
                            >
                        ...
                        <Grid className={classes.stat} item xs={10}>
                            <LinearProgress
                                ...
                                valueBuffer={Math.round(
                                    ((remaining + pending) / totalToSell) * 100,
                                )}
                            />
                        </Grid>
                    </Grid>
                                        ...
                                        <>
                                            <p>
                                                <strong>
                                                    ...
                                                    >
                                                        There are currently no more NFTs available,
                                                        but not all sales have settled yet. If these
