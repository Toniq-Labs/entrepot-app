            ...
            <div style={styles.main}>
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/icsnakes/banner.jpg')",
                        }}
                    ></div>
                ...
                >
                    ...
                    <Grid className={classes.stat} item md={4} xs={6}>
                        ...
                        <br />
                        <span style={{fontWeight: 'bold', color: '#00b894', fontSize: '2em'}}>
                            {remaining !== false ? 9000 - remaining : 'Loading...'}
                        </span>
                    </Grid>
                </Grid>
                <br />
                                        ...
                                        <p>
                                            <strong>
                                                <span style={{fontSize: '20px', color: 'black'}}>
                                                    ...
                                                    0.45ICP for the first 24 hours only!
                                                </span>
                                            </strong>
                                        </p>
                                    </>
                            ...
                            <p>
                                <strong>
                                    <span style={{fontSize: '20px', color: 'red'}}>
                                        Sorry, the sale is now over! You can grab your ICSnake from
