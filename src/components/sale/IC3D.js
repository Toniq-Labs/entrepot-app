...
export default function IC3D(props) {
    ...
    const _updates = async () => {
        var stats = await api
            .token('nfvlz-jaaaa-aaaah-qcciq-cai')
                ...
                <div style={styles.empty}>
                    <div className={classes.banner}>
                        <div
                            style={{
                                ...
                                backgroundImage: "url('/banner/ic3d.jpg')",
                            }}
                        ></div>
                    </div>
                    ...
                    >
                        ...
                        <Grid className={classes.stat} item md={3} xs={6}>
                            ...
                            <br />
                            <span style={{fontWeight: 'bold', color: '#00b894', fontSize: '2em'}}>
                                {remaining ? 7000 - remaining : 'Loading...'}
                            </span>
                        </Grid>
                    </Grid>
                    <br />
                        ...
                        <>
                            {!saleOver && remaining > 0 ? (
                                <>
                                    {Date.now() >= startTime ? (
                                        <>
                                            <Alert style={{marginBottom: 30}} severity="warning">
                                                <strong>
                                                    Anyone who purchased an NFT when the price was
                                                    2ICP will receive 4 free NFTs via airdrop in the
                                                    near future
                                                </strong>
                                            </Alert>
                                            <Grid
                                            ...
                                            <p>
                                                ...
                                                service only. By clicking the button below you show
                                                acceptance of our{' '}
                                                <a
                                ...
                                <p>
                                    <strong>
                                        <span style={{fontSize: '20px', color: 'red'}}>
                                            Sorry, the sale is now over! You can grab your IC3D
                                            scenes from the marketplace soon!
                                        </span>
                                    </strong>
                                </p>
                            )}
