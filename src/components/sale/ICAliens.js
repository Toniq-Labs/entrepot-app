                ...
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/icaliens/banner.jpg')",
                        }}
                    ></div>
                            ...
                            <p>
                                <strong>
                                    <span style={{fontSize: '20px', color: 'red'}}>
                                        Sorry, the sale is now over (pending any failed
                                        transactions, which will be recycled soon)! You can grab
                                        your NFT from the marketplace soon!
                                    </span>
                                </strong>
                            </p>
                        )}
