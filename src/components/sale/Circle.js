...
export default function Circle(props) {
  ...
  const _updates = async () => {
    var stats = await api.canister("z7mqv-liaaa-aaaah-qcnqa-cai", "sale").salesStats((props.account ? props.account.address : ""));
    ...
    try {
      ...
      while (true) {
        try {
          ...
          r3 = await api.canister("z7mqv-liaaa-aaaah-qcnqa-cai", "sale").retreive(paytoaddress);
