...
export default function Circle(props) {
    ...
    const _updates = async () => {
        var stats = await api
            .canister('z7mqv-liaaa-aaaah-qcnqa-cai', 'sale')
                ...
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/icircle/banner.png')",
                        }}
                    ></div>
                                ...
                                Date.now() < whitelistend ? (
                                    <>
                                        <p>
                                            <strong>
                                                <span style={{fontSize: '20px', color: 'black'}}>
                                                    You are on the whitelist! You can mint up to 2
                                                    NFTs at 1ICP each for the first 1 hour only!
                                                </span>
                                            </strong>
                                        </p>
