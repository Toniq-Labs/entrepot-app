...
export default function BlockchainHeroes(props) {
  ...
  const _updates = async () => {
    var stats = await api.canister("poyn6-dyaaa-aaaah-qcfzq-cai", "sale").salesStats((props.account ? props.account.address : ""));
    ...
    try {
      ...
      while (true) {
        try {
          ...
          r3 = await api.canister("poyn6-dyaaa-aaaah-qcfzq-cai", "sale").retreive(paytoaddress);
...
<p>Will you get an epic Captain Crypto, a legendary Lady Lightning or the elusive mythic Genesis? Grab your packs and rip them open to find out!
        ...
        <Grid container spacing={2} style={{}}>
          ...
          <Grid className={classes.stat} item md={4} xs={6}>
            ...
            <span style={{fontWeight:"bold",color:"#00b894",fontSize:"2em"}}>{remaining ? 5000-remaining : "Loading..."}</span>
          </Grid>
        </Grid>
        <br /><br />
        {remaining === false ? 
