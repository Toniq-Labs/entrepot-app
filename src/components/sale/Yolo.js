                ...
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/yolo/banner.jpg')",
                        }}
                    ></div>
                                ...
                                Date.now() < whitelistend ? (
                                    <>
                                        <p>
                                            <strong>
                                                <span style={{fontSize: '20px', color: 'black'}}>
                                                    You are on the whitelist! You can mint up to 4
                                                    NFTs at 0.5ICP for the first 24 hours only
                                                    (limited to first 1000 sold)!
                                                </span>
                                            </strong>
                                        </p>
