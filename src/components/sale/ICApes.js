            ...
            <div style={styles.main}>
                <div className={classes.banner}>
                    <div
                        style={{
                            ...
                            backgroundImage: "url('/collections/icapes/banner.jpg')",
                        }}
                    ></div>
                ...
                >
                    ...
                    <Grid className={classes.stat} item md={3} xs={6}>
                        ...
                        <br />
                        <span style={{fontWeight: 'bold', color: '#00b894', fontSize: '2em'}}>
                            {remaining !== false ? 9829 - remaining : 'Loading...'}
                        </span>
                    </Grid>
                </Grid>
                <br />
                                                        ...
                                                        {publicTimer ? (
                                                            ...
                                                            <p>
                                                                <strong>
                                                                    ...
                                                                    >
                                                                        The sale is only open to
                                                                        those on the whitelist. The
                                                                        public sale will start when
                                                                        the private sale has ended.
                                                                    </span>
                                                                </strong>
                                                            </p>
                                                        )}
                                        ...
                                        <p>
                                            <strong>
                                                <span style={{fontSize: '20px', color: 'black'}}>
                                                    The private (whitelist only) sale starts{' '}
                                                    <Timestamp
                                                        relative
                                                        autoUpdate
                                                        date={startTime / 1000}
                            ...
                            <p>
                                <strong>
                                    <span style={{fontSize: '20px', color: 'red'}}>
                                        Sorry, the sale is now over! You can grab your ICApe from
