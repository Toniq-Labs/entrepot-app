...
export default function Moonwalkers(props) {
  ...
  const buyFromSale = async (handle) => {
    ...
    var v = await props.confirm("Please confirm", "Are you sure you want to continue with this purchase? All transactions are final on confirmation and can't be reversed.")
    if (!v) return;
    try {
