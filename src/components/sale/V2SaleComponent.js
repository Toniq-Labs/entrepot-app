                      ...
                      if (badge) {
                        ...
                        return (
                          <Tab
                            className={classes.tabsViewTab}
                            value={Number(group.id)}
                            label={<span style={{padding: '0 0px'}}>{group.name}</span>}
                          />
                        );
                      }
                    })}
                ...
                <>
                  {!getCurrentGroup().available ? (
                    <p>
                      <strong>
                        <span style={{fontSize: '20px', color: 'black'}}>
                          This pricing group is no longer available due to purchase limits!
                        </span>
                      </strong>
                    </p>
                  ) : (
                            ...
                            <strong>
                              <span style={{fontSize: '20px', color: 'black'}}>
                                ...
                                <Timestamp
                                  relative
                                  autoUpdate
                                  date={Number(getCurrentGroup().start / 1000000n) / 1000}
                                />
                                !
                              </span>
                            </strong>
                              ...
                              return (
                                <Grid className={classes.stat} item sm={3}>
                                  ...
                                  >
                                    ...
                                    <br />
                                    for {_showListingPrice(o[0] * o[1])} ICP
                                  </Button>
                                </Grid>
                              );
                            })}
                                ...
                                <Grid className={classes.stat} item sm={3}>
                                  <Button
                                    ...
                                    onClick={() =>
                                      buyFromSale(
                                        Number(
                                          groups.find(a => Number(a.id) == currentPriceGroup).id,
                                        ),
                                        Number(o[0]),
                                        o[0] * o[1],
                                      )
