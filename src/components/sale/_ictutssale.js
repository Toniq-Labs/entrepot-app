...
export default function Sale(props) {
    ...
    const buyFromSale = async (qty) => {
        ...
        try {
            ...
            await api
                .token()
                .transfer(props.identity.getPrincipal(), 0, paytoaddress, pricetopay, 10000);
            var r3;
            while (true) {
                try {
    ...
    return (
        <>
            <div style={{maxWidth: '1200px', margin: '0 auto', textAlign: 'center'}}>
                ...
                <p>
                    <strong>
                        We will have all of the 10,000 NFTs available for sale at launch, there will
                        be 5 pirce tiers (Thirty NFTs will be reserved for the creators). We will
                        try to distrube them fairly as possible by whitelisting.
                    </strong>
                </p>
                <Grid container spacing={2} style={{}}>
                    ...
                    <Grid className={classes.stat} item xs={3}>
                        ...
                        <br />
                        <span style={{fontWeight: 'bold', color: '#00b894', fontSize: '2em'}}>
                            {_showListingPrice(whitelistPrice)} ICP
                        </span>
                    </Grid>
                    <Grid className={classes.stat} item xs={3}>
                        ...
                        {Date.now() < 1634421600000 ? (
                            <span style={{fontWeight: 'bold', color: '#00b894', fontSize: '2em'}}>
                                {_showListingPrice(300000000n)} ICP
                            </span>
                        ) : (
                            <span style={{fontWeight: 'bold', color: 'red', fontSize: '2em'}}>
                                BURN
                            </span>
                        )}
                    </Grid>
                    ...
                    <p>
                        <strong>
                            <span style={{fontSize: '1.5em', color: 'red'}}>
                                ...
                                <Timestamp relative autoUpdate date={1634421600} />
                            </span>
                        </strong>
                    </p>
                ) : (
                    <>
                        {Date.now() < 1634508000000 ? (
                            <p>
                                <strong>
                                    <span style={{fontSize: '1.5em', color: 'red'}}>
                                        All remaining ICTuTs will be burnt{' '}
                                        <Timestamp relative autoUpdate date={1634508000} />
                                    </span>
                                </strong>
                            </p>
                        ) : (
                            ...
                            <Grid container spacing={2} style={{}}>
                                <Grid className={classes.stat} item sm={3}>
                                    ...
                                    >
                                        Buy 1 ICTuT
                                        <br />
                                        for {_showListingPrice(whitelistPrice)} ICP
                                    </Button>
                                </Grid>
                                <Grid className={classes.stat} item sm={3}>
                                    <Button
                                    ...
                                    >
                                        Buy 5 ICTuT
                                        <br />
                                        for {_showListingPrice(whitelistPrice * 5n)} ICP
                                    </Button>
                                </Grid>
                                <Grid className={classes.stat} item sm={3}>
                                    <Button
                                    ...
                                    >
                                        Buy 10 ICTuT
                                        <br />
                                        for {_showListingPrice(whitelistPrice * 10n)} ICP
                                    </Button>
                                </Grid>
                                <Grid className={classes.stat} item sm={3}>
                                    <Button
                                    ...
                                    >
                                        Buy 20 ICTuT
                                        <br />
                                        for {_showListingPrice(whitelistPrice * 20n)} ICP
                                    </Button>
                                </Grid>
                            </Grid>
                            <p>
                                ...
                                transaction service only. By clicking the button below you show
                            ...
                            <p>
                                <strong>
                                    <span style={{color: 'red'}}>
                                        Sorry, the sale is now over! You can grab your ICTuT from
