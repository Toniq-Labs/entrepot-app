          ...
          <Grid item xs={12} sm={12} md={7}>
            ...
            <Typography variant="h4" className={classes.typo}>
              <a
                ...
                style={{color: '#648DE2', textDecoration: 'none', cursor: 'pointer'}}
              >
                {collection.name}
              </a>{' '}
                                ...
                                return (
                                  <TableRow key={i}>
                                    ...
                                    <TableCell align="right">
                                      ...
                                      <br />
                                      {EntrepotGetICPUSD(offer.amount) ? (
                                        <small>
                                          <PriceUSD price={EntrepotGetICPUSD(offer.amount)} />
                                        </small>
                                      ) : (
                                        ''
                                      )}
                                    ...
                                    <TableCell align="center">
                                      {floor ? getFloorDelta(offer.amount) : '-'}
                                    </TableCell>
                                    <TableCell align="center">
                                      <Timestamp
                                        relative
                      ...
                      {transactions.length == 0 ? (
                        ...
                        <>
                          ...
                          >
                            ...
                            <TableBody>
                              {transactions.slice().map((transaction, i) => {
                                return (
                                  <TableRow key={i}>
                                    <TableCell>
                                      <ShoppingCartIcon
                                    ...
                                    <TableCell align="right">
                                      <strong>
                                        <PriceICP price={BigInt(transaction.price)} />
                                      </strong>
                                      <br />
                                      {EntrepotGetICPUSD(BigInt(transaction.price)) ? (
                                        <small>
                                          <PriceUSD
                                            price={EntrepotGetICPUSD(BigInt(transaction.price))}
                                          />
                                        </small>
                                      ) : (
                                        ''
