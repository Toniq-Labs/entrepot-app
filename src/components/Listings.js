...
import {getPairing, getTraits} from './BTCFlowerStats.js';
...
export default function Listings(props) {
    ...
    const [collection, setCollection] = useState(
        collections.find((e) => e.route === params?.route),
    );
        ...
        return a.filter((_a) => {
            let background =
                backgroundFilter !== 'all'
                    ? backgroundFilter === getTraits(_a[0]).background
                    : true;
            ...
            let graveTexture =
                graveTextureFilter !== 'all'
                    ? graveTextureFilter === getTraits(_a[0]).grave.split('_').pop()
                    : true;
            let graveSymbol =
                graveSymbolFilter !== 'all'
                    ? graveSymbolFilter === getTraits(_a[0]).grave.split('_')[0]
                    : true;
            let pairing =
                pairingsFilter !== 'all' ? pairingsFilter === getPairing(getTraits(_a[0])) : true;
    ...
    const applyAdvancedFilters = (a) => {
        return a.filter(
            (_a) =>
                healthDominantValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.health.dominant &&
                healthDominantValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.health.dominant &&
                healthRecessiveValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.health.recessive &&
                healthRecessiveValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.health.recessive &&
                speedDominantValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.speed.dominant &&
                speedDominantValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.speed.dominant &&
                speedRecessiveValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.speed.recessive &&
                speedRecessiveValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.speed.recessive &&
                attackDominantValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.attack.dominant &&
                attackDominantValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.attack.dominant &&
                attackRecessiveValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.attack.recessive &&
                attackRecessiveValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.attack.recessive &&
                rangeDominantValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.range.dominant &&
                rangeDominantValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.range.dominant &&
                rangeRecessiveValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.range.recessive &&
                rangeRecessiveValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.range.recessive &&
                magicDominantValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.magic.dominant &&
                magicDominantValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.magic.dominant &&
                magicRecessiveValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.magic.recessive &&
                magicRecessiveValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.magic.recessive &&
                defenseDominantValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.defense.dominant &&
                defenseDominantValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.defense.dominant &&
                defenseRecessiveValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.defense.recessive &&
                defenseRecessiveValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.defense.recessive &&
                resistanceDominantValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.resistance.dominant &&
                resistanceDominantValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.resistance.dominant &&
                resistanceRecessiveValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.resistance.recessive &&
                resistanceRecessiveValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.resistance.recessive &&
                basicDominantValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.basic.dominant &&
                basicDominantValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.basic.dominant &&
                basicRecessiveValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.basic.recessive &&
                basicRecessiveValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.basic.recessive &&
                specialDominantValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.special.dominant &&
                specialDominantValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.special.dominant &&
                specialRecessiveValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.special.recessive &&
                specialRecessiveValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.special.recessive &&
                baseDominantValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.base.dominant &&
                baseDominantValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.base.dominant &&
                baseRecessiveValue[0] <=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.base.recessive &&
                baseRecessiveValue[1] >=
                    getGenes(_a[2].nonfungible.metadata[0]).battle.base.recessive,
        );
    };
        ...
        try {
            var img =
                canisterId === 'bxdf4-baaaa-aaaah-qaruq-cai'
                    ? 'https://qcg3w-tyaaa-aaaah-qakea-cai.raw.ic0.app/Token/' + listing[0]
    ...
    const applyFilters = (a, s, c) => {
        if (c === 'tde7l-3qaaa-aaaah-qansa-cai' && wearableFilter !== 'all') {
            var map = ['accessories', 'hats', 'eyewear', 'pets'];
            a = a.filter((_a) => map[_a[2].nonfungible.metadata[0][0]] === wearableFilter);
        } else if (c === 'e3izy-jiaaa-aaaah-qacbq-cai' && s === 'all') {
            a = applyAdvancedFilters(a);
        } else if (c === 'pk6rk-6aaaa-aaaae-qaazq-cai' && s === 'all') {
            ...
            <div style={{marginLeft: drawerWidth, paddingBottom: 100}}>
                <div style={{maxWidth: 1200, margin: '0 auto 50px'}}>
                        ...
                        style={{
                            ...
                            background:
                                typeof collection.banner != 'undefined' && collection.banner
                                    ? "url('" + collection.banner + "') no-repeat center center"
                                    : '#aaa',
                    ...
                    <div style={{textAlign: 'center'}}>
                                ...
                                {stats === false ? (
                                    ...
                                    <>
                                        {stats === null ? (
                                            ...
                                            >
                                                <Grid
                                                    style={{borderRight: '1px dashed #ddd'}}
                                                    item
                                                    md={4}
                                                >
                            ...
                            <Grid item md={4} xs={12} style={{textAlign: 'center'}}>
                                <ul className={classes.socials}>
                                    {['telegram', 'twitter', 'medium', 'discord']
                                        .filter(
                                            (a) => collection.hasOwnProperty(a) && collection[a],
                                        )
                                        .map((a) => {
                                            return (
                                                <li key={a}>
                        ...
                        <p style={{marginTop: 50, fontSize: '1.2em'}}>{collection?.blurb}</p>
                    </div>
                </div>
                {_isCanister(collection.canister) && collection.market ? (
                    <div
                        style={
                            gridSize === 'small'
                                ? {width: 1200, margin: '0 auto', marginTop: '10px'}
                        ...
                        >
                            ...
                            ['pk6rk-6aaaa-aaaae-qaazq-cai'].indexOf(collection?.canister) >= 0 ? (
                                <FormControl style={{marginRight: 20, minWidth: 120}}>
                                    ...
                                    <Select
                                        value={graveTextureFilter}
                                        onChange={changeGraveTextureFilter}
                                    >
                                        <MenuItem value={'all'}>All</MenuItem>
                                        <MenuItem value={'gold'}>Gold</MenuItem>
                                        <MenuItem value={'diamond'}>Diamond</MenuItem>
                            ...
                            ['pk6rk-6aaaa-aaaae-qaazq-cai'].indexOf(collection?.canister) >= 0 ? (
                                <FormControl style={{marginRight: 20, minWidth: 120}}>
                                    ...
                                    <Select
                                        value={graveSymbolFilter}
                                        onChange={changeGraveSymbolFilter}
                                    >
                                        <MenuItem value={'all'}>All</MenuItem>
                            ...
                            ['pk6rk-6aaaa-aaaae-qaazq-cai'].indexOf(collection?.canister) >= 0 ? (
                                <FormControl style={{marginRight: 20, minWidth: 120}}>
                                    ...
                                    <Select
                                        ...
                                        onChange={changeBackgroundFilter}
                                    >
                                        <MenuItem value={'all'}>All</MenuItem>
                                        <MenuItem value={'white'}>White</MenuItem>
                                            ...
                                            <div style={{marginTop: '20px', marginLeft: '30px'}}>
                                                ...
                                                <Box sx={{width: 150}}>
                                                    <Slider
                                                        ...
                                                        onChange={
                                                            handleResistanceDominantValueChange
                                                        }
                                                        min={0}
                                                        step={1}
                                                        max={63}
                                                ...
                                                <Box sx={{width: 150}}>
                                                    <Slider
                                                        ...
                                                        onChange={
                                                            handleResistanceRecessiveValueChange
                                                        }
                                                        min={0}
                                                        step={1}
                                                        max={63}
                                                            ...
                                                            .map((listing, i) => {
                                                                return (
                                                                    <Listing
                                                                        ...
                                                                        onListingDialogChange={
                                                                            changeListingDialogOpen
                                                                        }
                                                                    />
                                                                );
                                                            })}
                                        ...
                                        {transactions.length === 0 ? (
                                            <div style={styles.empty}>
                                                <Typography
                                                    ...
                                                    align="center"
                                                >
                                                    There are currently no sold transactions for
                                                    this collection
                                                </Typography>
                                            </div>
                                        ) : (
