            ...
            <div style={{}}>
                ...
                {_isCanister(collection.canister) && collection.market ? (
                    ...
                    >
                        <div
                            className={
                                toggleFilter ? classes.filtersViewOpen : classes.filtersViewClosed
                            }
                        >
                            <List>
                                <ListItem
                                        ...
                                        {collection?.route == 'cronics' ? (
                                            <>
                                                {cronicFilterTraits.map(filterName => {
                                                    return (
                                                        <div
                                                            key={'cronicFilterTraits' + filterName}
                                                        >
                                                            <ListItem
                                                                style={{paddingRight: 0}}
                                                                button
