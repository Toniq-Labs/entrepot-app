        ...
        <div style={{minHeight: 'calc(100vh - 221px)'}}>
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: '16px'}}>
                <StyledTabs
                    ...
                    onChange={(e, tab) => {
                        if (tab === 'activity')
                            navigate(`/marketplace/${collection?.route}/activity`);
                    }}
                >
                                    ...
                                    <div>
                                        ...
                                        >
                                            <div className={classes.filterAccordionWrapper}>
                                                <ToniqSlider
                                                    logScale={
                                                        filterRanges[currentFilters.price.type]
                                                            .max -
                                                            filterRanges[currentFilters.price.type]
                                                                .min >
                                                        10000
                                        ...
                                        >
                                            {collection?.route === 'cronics' ? (
                                                <Grid container spacing={2}>
                                                    {traitsCategories.map(
                                                        (traitsCategory, index) => {
                                                            return (
                                                                                            ...
                                                                                            >
                                                                                                <ToniqCheckbox
                                                                                                    ...
                                                                                                    onCheckedChange={event => {
                                                                                                        const traitIndex =
                                                                                                            currentFilters.traits.values.findIndex(
                                                                                                                trait => {
                                                                                                                    return (
                                                                                                                        trait.category ===
                                                                                                                        traitsCategory.category
