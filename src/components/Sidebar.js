                                ...
                                <ListItemSecondaryAction>
                                    <ListItemIcon>
                                        <Button
                                            ...
                                            variant={'contained'}
                                            onClick={() =>
                                                navigate('/marketplace/' + props.collection.route)
                                            }
                                    ...
                                    <>
                                        {myCollections.map(_collection => {
                                            return (
                                                <ListItem
                                                    key={
                                                        _collection.canister +
                                                        '-' +
                                                        _collection.count
                                                    }
                                                    selected={
                                                        props.view === 'wallet' &&
                                                        _collection.route == props.collection?.route
                                                    }
                                                    button
                                                    onClick={() =>
                                                        navigate('/wallet/' + _collection.route)
                                                    }
                                                >
                                                    <ListItemAvatar>
                                                        <Avatar>
