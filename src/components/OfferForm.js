...
export default function OfferForm(props) {
    ...
    const _submit = async () => {
        ...
        if (props.balance < icp + 10000n)
            return props.error('Your balance is insufficient to make this offer');
        handleClose();
        ...
        props.loader(false);
        props.alert('Offer submitted', 'Your offer was submitted successfully!');
    };
    const handleClose = () => {
        setAmount('');
        props.close();
        ...
        <>
            <Dialog open={props.open} onClose={handleClose} maxWidth={'xs'} fullWidth>
                ...
                <DialogContent>
                    ...
                    <Alert severity="info">
                        Offers are non-binding and indicative only. If the seller lists the NFT at
                        or below the price of your offer, it will not automatically buy it for you.
                        Limit 1 offer per NFT per principal.
                    </Alert>
                    <TextField
                        style={{width: '100%'}}
                        margin="dense"
