    ...
    <>
      <Dialog open={props.open} onClose={handleClose} maxWidth={'xs'} fullWidth>
        ...
        <DialogContent>
          ...
          <Alert severity="info">
            Offers are non-binding and indicative only. If the seller lists the NFT at or below the
            price of your offer, it will not automatically buy it for you. Limit 1 offer per NFT per
            principal.
          </Alert>
          <TextField
            style={{width: '100%'}}
