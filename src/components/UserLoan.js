                                ...
                                <div style={styles.empty}>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            valuable NFTs to withdraw short-term liquidity from the
                                            protocol, or (2) deposit ICP into the protocol via an
                                            Earn Contract to earn interest or receive discounted
                                            NFTs.
                                            <br />
                                            <br />
                                            Our unique approach is to tokenize the Earn Contract
                                            into a tradeable NFT where the contract NFT owner
                                            receives the interest or NFTs when the contract is
                                            repaid or not.{' '}
                                            <strong>
                                                This creates a secondary market for Earn Contracts.
                                            </strong>
                                        </div>
                                        {props.identity ? (
                                            <>
                                        ...
                                        <Button
                                            ...
                                            onClick={() =>
                                                window.open('/marketplace/earn-contracts')
                                            }
                                        >
              ...
              <ListItem>
                ...
                >
                    ...
                    {props.view == 'earn-contracts' ? (
                        <>
                            <Alert severity="info" style={{marginBottom: 20, textAlign: 'center'}}>
                                These are your open Earn Contracts. You will need to repay the
                                contract in full (amount and reward) before the end date otherwise
                                you will lose your NFT
                            </Alert>
                        </>
                    ) : (
                        ''
                    ...
                    {props.view == 'earn-requests' ? (
                        <>
                            <Alert severity="info" style={{marginBottom: 20, textAlign: 'center'}}>
                                You can view your current Earn Contracts here. Once someone accepts
                                your request, it will be moved to the Earn Contracts screen. Earn
