    ...
    <div style={{minHeight: 'calc(100vh - 221px)', marginBottom: -75}}>
      {props.view == 'earn' ? (
              ...
              <div style={{textAlign: 'center'}}>
                <div style={styles.empty}>
                  ...
                  <div style={{width: '100%', maxWidth: '760px', margin: '-30px auto 40px'}}>
                    ...
                    >
                      ...
                      <strong>a 100% non-custodial and decentralized interest rate protocol</strong>{' '}
                      running on the Internet Computer. Learn more{' '}
                      <a href="https://4orvc-saaaa-aaaak-qapjq-cai.raw.ic0.app/">here</a>. Users can
                      (1) create an Earn Contract by locking up valuable NFTs to withdraw short-term
                      liquidity from the protocol, or (2) deposit ICP into the protocol via an Earn
                      Contract to earn interest or receive discounted NFTs.
                      <br />
                      <br />
                      Our unique approach is to tokenize the Earn Contract into a tradeable NFT
                      where the contract NFT owner receives the interest or NFTs when the contract
                      is repaid or not.{' '}
                      <strong>This creates a secondary market for Earn Contracts.</strong>
                    </div>
                    {props.identity ? (
                      <>
                        <Button
                    ...
                    <Button
                      ...
                      onClick={() => window.open('/marketplace/earn-contracts')}
                    >
                ...
                >
                  ...
                  <Tab
                    ...
                    label={
                      <span style={{padding: '0 50px'}}>
                        <GavelIcon style={{position: 'absolute', marginLeft: '-30px'}} />
                        <span style={{}}>Earn Contracts</span>
                      </span>
                    }
                  />
                </Tabs>
        ...
        <UserDetail
          ...
          classes={classes}
          address={address}
          title={myPage ? 'My Collection' : address.substr(0, 12) + '...'}
        />
      )}
      <div
        id="mainNfts"
      ...
      >
        <div className={toggleFilter ? classes.filtersViewOpen : classes.filtersViewClosed}>
          <List>
            <ListItem style={{paddingRight: 0}} button onClick={changeToggleFilter}>
              ...
              />
              <ListItemIcon>{toggleFilter ? <CloseIcon fontSize={'large'} /> : ''}</ListItemIcon>
            </ListItem>
            {toggleFilter ? (
              <>
            ...
            */}
                ...
                <ListItem>
                  <div style={{width: '100%'}}>
                    <TextField
                      value={minFloor}
                      onChange={minFloorChange}
                      style={{width: '100%', marginBottom: 20}}
                      label="Min. Floor Rate%"
                    />
                    <TextField
                      value={maxFloor}
                      onChange={maxFloorChange}
                      style={{width: '100%', marginBottom: 20}}
                      label="Max. Floor Rate%"
                    />
                  </div>
                </ListItem>
                <ListItem style={{paddingRight: 0}}>
              ...
              <ListItem>
                ...
                <ListItem>
                  <div style={{width: '100%'}}>
                    <TextField
                      value={minApr}
                      onChange={minAprChange}
                      style={{width: '100%', marginBottom: 20}}
                      label="Min. APR%"
                    />
                    <TextField
                      value={maxApr}
                      onChange={maxAprChange}
                      style={{width: '100%', marginBottom: 20}}
                      label="Max. APR%"
                    />
                  </div>
        ...
        <div className={classes.listingsView} style={{flexGrow: 1, padding: '10px 16px 50px 16px'}}>
          ...
          {props.view == 'earn-contracts' ? (
            <>
              <Alert severity="info" style={{marginBottom: 20, textAlign: 'center'}}>
                These are your open Earn Contracts. You will need to repay the contract in full
                (amount and reward) before the end date otherwise you will lose your NFT
              </Alert>
            </>
          ) : (
            ''
          ...
          {props.view == 'earn-requests' ? (
            <>
              <Alert severity="info" style={{marginBottom: 20, textAlign: 'center'}}>
                You can view your current Earn Contracts here. Once someone accepts your request, it
                will be moved to the Earn Contracts screen. Earn Requests automatically expire after
                24 hours.
              </Alert>
            </>
          ) : (
                ...
                <Typography paragraph style={{fontWeight: 'bold'}} align="left">
                  {minAmount ? (
                    <Chip
                      ...
                      label={'Min. Amount: ' + minAmount + 'ICP'}
                  ...
                  {maxAmount ? (
                    <Chip
                      style={{marginRight: 10, marginBottom: 10}}
                      label={'Max. Amount: ' + maxAmount + 'ICP'}
                  ...
                  {minFloor ? (
                    <Chip
                      style={{marginRight: 10, marginBottom: 10}}
                      label={'Min. Floor: ' + minFloor + '%'}
                      onDelete={() => setMinFloor('')}
                      color="primary"
                    />
                  ) : (
                    ''
                  ...
                  {maxFloor ? (
                    <Chip
                      style={{marginRight: 10, marginBottom: 10}}
                      label={'Max. Floor: ' + maxFloor + '%'}
                      onDelete={() => setMaxFloor('')}
                      color="primary"
                    />
                  ) : (
                    ''
                  ...
                  <Table style={{width: '100%', overflow: 'hidden'}}>
                    <TableHead>
                      <TableRow>
                        ...
                        <TableCell align="center">
                          <Tooltip title="The percentage of the collection floor for the NFT that is being requested in the Earn Request.">
