...
export default function Listings(props) {
    ...
    const [
        healthDominantValue,
        setHealthDominantValue,
    ] = React.useState([
        0,
        63,
    ]);
    const [
        healthRecessiveValue,
        setHealthRecessiveValue,
    ] = React.useState([
        0,
        63,
    ]);
    ...
    const [
        attackDominantValue,
        setAttackDominantValue,
    ] = React.useState([
        0,
        63,
    ]);
    const [
        attackRecessiveValue,
        setAttackRecessiveValue,
    ] = React.useState([
        0,
        63,
    ]);
    ...
    const [
        magicRecessiveValue,
        setMagicRecessiveValue,
    ] = React.useState([
        0,
        63,
    ]);
    const [
        defenseDominantValue,
        setDefenseDominantValue,
    ] = React.useState([
        0,
        63,
    ]);
    const [
        defenseRecessiveValue,
        setDefenseRecessiveValue,
    ] = React.useState([
        0,
        63,
    ]);
    const [
        resistanceDominantValue,
        setResistanceDominantValue,
    ] = React.useState([
        0,
        63,
    ]);
    const [
        resistanceRecessiveValue,
        setResistanceRecessiveValue,
    ] = React.useState([
        0,
        63,
    ]);
    ...
    const [
        basicRecessiveValue,
        setBasicRecessiveValue,
    ] = React.useState([
        0,
        63,
    ]);
    const [
        specialDominantValue,
        setSpecialDominantValue,
    ] = React.useState([
        0,
        63,
    ]);
    const [
        specialRecessiveValue,
        setSpecialRecessiveValue,
    ] = React.useState([
        0,
        63,
    ]);
                ...
                <h1>
                    ...
                    <FormControl>
                        <Select
                            ...
                            value={
                                typeof collection?.canister == 'undefined'
