...
export default function Listings(props) {
  ...
  const applyAdvancedFilters = a => {
    return a.filter(
      _a =>
        healthDominantValue[0] <= getGenes(_a[2].nonfungible.metadata[0]).battle.health.dominant &&
          ...
          <FormControl>
            ...
            >
              {props.collections.map(_collection => {
                return (
                  <MenuItem key={_collection.canister} value={_collection.canister}>
                    {_collection.name}
                    {_collection.mature ? (
                      <Chip
                  ...
                  {transactions.length === 0 ? (
                    <div style={styles.empty}>
                      <Typography
                        ...
                        align="center"
                      >
                        There are currently no sold transactions for this collection
                      </Typography>
                    </div>
                  ) : (
                    <>
