...
export const defaultProfileFilters = wrapNarrowTypeWithTypeCheck<FilterDefinitions<Collection>>()({
    'Floor Price': {
...
export const profileSortDefinitions = wrapNarrowTypeWithTypeCheck<
