...
export function NftCardPlaceholder(props) {
    ...
    const useStyles = makeStyles(theme => ({
        ...
        container: {
            ...
            '&::after': {
                ...
                borderRadius: '4px',
                backgroundImage:
                    'linear-gradient(90deg, rgba(246, 247, 248, 0) 0, rgba(246, 247, 248, 0.4) 20%, rgba(246, 247, 248, 0.4) 40%, rgba(246, 247, 248, 0) 100%)',
    ...
    return (
        <DropShadowCard className={classes.container} enableHover={true} style={{...props.style}}>
