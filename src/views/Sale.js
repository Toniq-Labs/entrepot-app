    ...
    var cards = [
        {
            ...
            content: (
                <>
                    This collection contains ethnic art AI renderings. With more than 94 countries
                    from seven continents, there is one that everybody can relate to! More to come
                    in next ventures!
                </>
            ),
        },
        {
            ...
            content: (
                <>
                    This collection was designed with the intent of game/metaverse intergration in
                    the future.
                </>
            ),
        },
        ...
        // },
        {
            ...
            content: (
                <>
                    'You Only Live Once' - No NFTs will sit idle. Amazing tools where u can create
                    animation, add music & enter DIGITAL STUDIO. 3D collection will also be launched
                    soon.
                </>
            ),
        },
            ...
            <div style={{width: '100%', display: 'block', position: 'relative'}}>
                ...
                >
                    <h1 className={classes.heading}>
                        The latest NFT launches on the Internet Computer!
                    </h1>
