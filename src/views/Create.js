    ...
    var cards = [
        {
            ...
            content: (
                <>
                    Poked bots by Poked Studio! These 10,000 unique bots designed by Internet
                    Computer legend — Jon Ball — are making their way into the metaverse{' '}
                </>
            ),
        },
        {
            ...
            content: (
                <>
                    In early 2018, BTC Flower by street artist ludo made its debut on the streets of
                    Paris. The digital version of the R.I.P Banking System art piece exists as an
                    assortment of 2009 unique variations.
                </>
            ),
        },
        {
            ...
            content: (
                <>
                    1000 OG Medals airdropped by DKLORD89 "Drop King" to to active early believers
                    inside the most popular WEB 3.0 decentralized social media platform: DSCVR!
                </>
            ),
        },
    ];
                            ...
                            >
                                <Grid item xs={4} sm={3} md={2} style={{textAlign: 'right'}}>
                                    <Button
                                        ...
                                        variant="outlined"
                                        target="_blank"
                                        href="https://toniq-labs.gitbook.io/toniq-mint/"
                                    >
                                        User Guide
                                    </Button>
                                </Grid>
                                ...
                                <Grid item xs={4} sm={3} md={2} style={{textAlign: 'left'}}>
                                    <Button
                                        ...
                                        variant="outlined"
                                        target="_blank"
                                        href="https://calendar.google.com/calendar/u/0?cid=Y184dG5qZmhhbW91Y281aHRuc2M1aDZmNTNtc0Bncm91cC5jYWxlbmRhci5nb29nbGUuY29t"
                                    >
                                        Launch Calendar
                                    </Button>
                                </Grid>
