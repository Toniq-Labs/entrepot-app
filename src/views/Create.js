    ...
    var cards = [
        {
            ...
            content: (
                <>
                    Cronic Wearables! These are a seperate collection of NFTs that you can send to
                    your Cronic, and it will wear it!
                </>
            ),
        },
        {
            ...
            content: (
                <>
                    Make your friends smile with these unique NFTs or collect them all! Plans are
                    being developed to make ICmojis even more fun to use so stay tuned for future
                    updates!
                </>
            ),
        },
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} sm={12} md={12}>
                            <p style={{textAlign: 'center', fontSize: '1.3em'}}>
                                ...
                                and we will be in touch! Our self-minting portal will be available
                                for public use this year so stay tuned for updates!
                            </p>
                        </Grid>
                    </Grid>
                    <Features />
